...
*   **2.2.** Το σύστημα θα κατηγοριοποιεί και θα εμφανίζει το πλήθος των άρθρων ανά Συγγραφέα (Author) και ανά Ιστοσελίδα (Site). **(Υψηλή)**
*   **2.3.** Το σύστημα θα αντλεί τα σχόλια (comments) και τις απαντήσεις (replies) αυτών και θα τα συσχετίζει με τον αντίστοιχο συγγραφέα του άρθρου. **(Υψηλή)**
*   **2.4.** Δυνατότητα εμφάνισης συγκεντρωτικών στατιστικών: Συνολικά σχόλια ανά συγγραφέα σε όλα τα sites που διαχειρίζεται. **(Μέση)**
...
| **Συλλογή Δεδομένων (WordPress)** | data_col_1 | Αυτόματη άντληση άρθρων (posts) μέσω WP API και αποθήκευση στη βάση. | MH | user_mgmt_2 | 4 | 1 |
...
| **Ανάλυση & Dashboard** | dash_view_1 | Κεντρική οθόνη Dashboard: Προβολή συγκεντρωτικών λιστών (άρθρα/σχόλια) ανά site. | MH | data_col_1, data_col_2 | 4 | 2 |
